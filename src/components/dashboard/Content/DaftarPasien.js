...
export const DaftarPasien = () => {
  ...
  const getPatientPhoto = (patientId) => {
    axios({
      method: "get",
      url: `${url.prod}/doctor/patient/photo?id=${patientId}`,
    })
      .then((response) => {
        return response;
      })
  ...
  const getPatientCurrentMonitoring = (patientId) => {
    axios({
      method: "get",
      url: `${url.prod}/doctor/patient/monitoring?id=${patientId}`,
    })
      .then((response) => {
        return response;
      })
  ...
  const getPatientCurrentSensorData = (patientId) => {
    axios({
      method: "get",
      url: `${url.prod}/doctor/patient/sensor?id=${patientId}`,
    })
      .then((response) => {
        return response;
      })
  ...
  const getPatientCurrentLocation = (patientId) => {
    axios({
      method: "get",
      url: `${url.prod}/doctor/patient/location?id=${patientId}`,
    })
      .then((response) => {
        return response;
      })
