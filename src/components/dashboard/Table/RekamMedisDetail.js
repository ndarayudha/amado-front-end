...
import { getPaientCurrentMonitoring } from "./api";
...
export const RekamMedisDetail = () => {
  ...
  useEffect(() => {
    dispatch(getPaientCurrentMonitoring(id));
  }, [dispatch, id]);
            ...
            {detailBio ? (
              <div>
                ...
                <Input
                  style={{ marginBottom: "10px" }}
                  placeholder="Nama"
                  value={detailBio ? detailBio.name : ""}
                />
                <Title level={5}>Tanggal Lahir</Title>
                <Input
                  style={{ marginBottom: "10px" }}
                  placeholder="Umur"
                  value={detailBio ? detailBio.tanggal_lahir : ""}
                />
                <Title level={5}>Nomor Telepon</Title>
                <Input
                  style={{ marginBottom: "10px" }}
                  placeholder="phone"
                  value={detailBio ? detailBio.phone : ""}
                />
                <Title level={5}>Alamat</Title>
                <Input
                  style={{ marginBottom: "10px" }}
                  placeholder="Alamat"
                  value={detailBio ? detailBio.alamat : ""}
                />
              </div>
            ) : (
              <Skeleton />
